...
def openapi_spec(base="https://dart.pokt-agent.com"):
    ...
    return {
        ...
        "paths": {
            ...
            "/v1/asof": {"get": {"summary": "Filings effective as of a date (later corrections excluded)", "parameters": [cc, {"name": "date", "in": "query", "required": True, "schema": {"type": "string", "pattern": "^\\d{8}$"}},
                                {"name": "lookback_days", "in": "query", "schema": {"type": "integer", "default": 120, "minimum": 7, "maximum": 365}, "description": "window before as_of; the DART list API returns at most 1,000 filings per query, so heavy filers need a shorter window"}],
                                "responses": {"200": {"description": "dart-asof/v1"}}}},
